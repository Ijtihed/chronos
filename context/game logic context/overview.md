...
Character assignment reflects the realistic demographic distribution of the era. In any given period, most people are farmers, craftsmen, merchants, soldiers, or clergy — so most assignments reflect that distribution. There is a small persistent bias toward historically significant figures including rulers, meaning the player will occasionally be assigned a king, sultan, emperor, or equivalent. This is not earned or unlocked — it is a statistical thumb on the scale toward the historically interesting, present from the very first run.
