...
# All offline tests (no API key needed; this is what CI runs)
python -m pytest tests/ -m "not live" -q

# Live tests (require a real GEMINI_API_KEY; will burn a small amount of API credit)
...
docs/                 Long-form docs (incl. UI prototype mockups)
versions/             Weekly snapshot changelogs (see .cursor/rules/chronos-weekly-versions.mdc)
...
- See [CONTRIBUTING.md](CONTRIBUTING.md) for the design-first workflow,
